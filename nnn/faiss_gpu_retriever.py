...
class FaissGPURetriever(Retriever):
    def __init__(self, 
        ...
        self.reference_index = faiss.index_cpu_to_gpu(resources, gpu_id, cpu_reference_index, co)
        ...
        self.retrieval_index = faiss.index_cpu_to_gpu(resources, gpu_id, cpu_retrieval_index, co)
    ...
    def setup_retriever(self, retrieval_embeds, reference_embeds, alternate_ks, batch_size):
        ...
        modified_retrieval_embeds = np.concatenate([numpy_retrieval_embeds, alignment_means], axis=1)
